...
namespace Kütüphane3.Forms
{
    public partial class HikayeForm : Form
    {
        ...
        private void HikayeForm_Load(object sender, EventArgs e)
        {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO Hikaye (adi, turu, yazari, id) VALUES (@adi, @turu, @yazari, @id)";
        ...
        private void LoadBooksToGrid()
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM Hikaye"; // Kitaplar tablosundaki tüm veriler
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                try
                {
                    ...
                    string query = "DELETE FROM Hikaye WHERE ID = @id";
                    MySqlCommand command = new MySqlCommand(query, connection);

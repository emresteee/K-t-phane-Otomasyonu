...
{
    public partial class PskForm : Form
    {
        public PskForm()
        {
            InitializeComponent();
        ...
        private void PskForm_Load(object sender, EventArgs e)
        {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO Psk (adi, turu, yazari, id) VALUES (@adi, @turu, @yazari, @id)";
        ...
        private void LoadBooksToGrid()
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM Psk"; // Kitaplar tablosundaki tüm veriler
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                try
                {
                    ...
                    string query = "DELETE FROM Psk WHERE ID = @id";
                    MySqlCommand command = new MySqlCommand(query, connection);

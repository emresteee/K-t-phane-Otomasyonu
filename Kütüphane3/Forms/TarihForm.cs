...
{
    public partial class TarihForm : Form
    {
        public TarihForm()
        {
            InitializeComponent();
        ...
        private void TarihForm_Load(object sender, EventArgs e)
        {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO Tarih (adi, turu, yazari, id) VALUES (@adi, @turu, @yazari, @id)";
        ...
        private void LoadBooksToGrid()
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM Tarih"; // Kitaplar tablosundaki tüm veriler
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                try
                {
                    ...
                    string query = "DELETE FROM Tarih WHERE ID = @id";
                    MySqlCommand command = new MySqlCommand(query, connection);

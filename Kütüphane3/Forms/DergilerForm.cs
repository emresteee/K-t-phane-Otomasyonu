...
{
    public partial class DergilerForm : Form
    {
        public DergilerForm()
        {
            InitializeComponent();
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO Dergiler (adi, turu, yazari, id) VALUES (@adi, @turu, @yazari, @id)";
        ...
        private void LoadBooksToGrid()
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM Dergiler"; // Kitaplar tablosundaki tüm veriler
        ...
        private void DergilerForm_Load(object sender, EventArgs e)
        {
            string connectionString = "Server=localhost; Database=kutuphane; Uid=root; Pwd=root;";
            MySqlConnection connection = new MySqlConnection(connectionString);
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                try
                {
                    ...
                    string query = "DELETE FROM Dergiler WHERE ID = @id";
                    MySqlCommand command = new MySqlCommand(query, connection);
